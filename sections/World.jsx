  ...
  <section className={`${styles.paddings} relative z-10`} id="world">
    ...
    >
      ...
      <TitleText
        title={
          <>
            Track your friends and invite them to play together in the same
            world
          </>
        }
      ...
      >
        ...
        <div className="absolute bottom-20 left-[15%] w-[195px] h-[150px] p-[6px] rounded-[24px] bg-[#5D6680] invisible md:visible">
          <img
            src="card-01.png"
            alt="card-01"
            className="w-full h-full rounded-[24px] object-cover"
